...
These figures use the nominal load_x1p00 selected-checkpoint held-out rich metrics
...
Run with:
    ...
    /opt/homebrew/Caskroom/miniconda/base/envs/rl/bin/python \
        docs/paper/reproduction/generate_section5_nominal_mechanism_figures_20260715.py
"""
