...
This script reads only registered evidence tables under docs/paper/evidence_tables.
It writes manuscript-facing PDF panels to docs/paper/manuscript_overleaf/figures
and uses docs/paper/reproduction/generated_figures only for optional draft panels.
