...
The script consumes the registered aggregate CSV under docs/paper/table_sources
and writes PDF/PNG/SVG copies to both figure_sources and manuscript/figures.
"""
...
FIG_SRC_DIR = ROOT / "docs/paper/figure_sources/performance_evaluation_20260714"
